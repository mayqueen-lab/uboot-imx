 ...
 */
#ifndef __COCONUT_CONFIG_H
#define __COCONUT_CONFIG_H
...
#define CONFIG_SYS_FSL_ESDHC_ADDR	USDHC2_BASE_ADDR  ///0
...
/*#define CONFIG_MFG_TOOLS*/
#if defined(CONFIG_MFG_TOOLS)
...
#define CONFIG_ENV_OFFSET		(SZ_4M - CONFIG_ENV_SIZE)   // (37 << 20)
#endif

#define CONFIG_SYS_MMC_ENV_DEV		0	///1   /* USDHC2 */
#define CONFIG_SYS_MMC_ENV_PART		0	/* user area */
#define CONFIG_MMCROOT			"/dev/mmcblk0p2"  /// "/dev/mmcblk1p2"  /* USDHC2 */
